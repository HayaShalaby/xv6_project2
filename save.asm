...
int main(int argc, char*argv[])
{
  ...
  2a:	e8 61 04 00 00       	call   490 <printf>
	exit();
  2f:	e8 ff 02 00 00       	call   333 <exit>
	}
  ...
  35:	51                   	push   %ecx
  36:	6a 01                	push   $0x1
  38:	ff 76 04             	push   0x4(%esi)
  3b:	e8 33 03 00 00       	call   373 <open>
	//to it directly
	if(file < 0){
  ...
  72:	53                   	push   %ebx
  73:	e8 db 02 00 00       	call   353 <write>
		if(i != argc - 1)
  78:	83 c4 10             	add    $0x10,%esp
  7b:	39 7d e0             	cmp    %edi,-0x20(%ebp)
  ...
  83:	6a 01                	push   $0x1
  85:	68 d6 07 00 00       	push   $0x7d6
  8a:	53                   	push   %ebx
  8b:	e8 c3 02 00 00       	call   353 <write>
  90:	83 c4 10             	add    $0x10,%esp
	for(int i = 2; i <argc; i++)
  93:	83 c7 01             	add    $0x1,%edi
  96:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
  99:	75 c5                	jne    60 <main+0x60>
		}
	}
	close(file);
  9b:	83 ec 0c             	sub    $0xc,%esp
  9e:	53                   	push   %ebx
  9f:	e8 b7 02 00 00       	call   35b <close>
	exit();
  a4:	e8 8a 02 00 00       	call   333 <exit>
	 file = open(argv[1], O_CREATE | O_WRONLY); // if it doesnt exist create it (in the writing mode )and open it
  a9:	52                   	push   %edx
  aa:	52                   	push   %edx
  ab:	68 01 02 00 00       	push   $0x201
  b0:	ff 76 04             	push   0x4(%esi)
  b3:	e8 bb 02 00 00       	call   373 <open>
	if(file < 0){
  ...
  bf:	79 88                	jns    49 <main+0x49>
	printf(2, "cannot open the file %s from the save command \n", argv[1]);
  c1:	50                   	push   %eax
  c2:	ff 76 04             	push   0x4(%esi)
  c5:	68 d8 07 00 00       	push   $0x7d8
  ca:	6a 02                	push   $0x2
  cc:	e8 bf 03 00 00       	call   490 <printf>
	exit();
  d1:	e8 5d 02 00 00       	call   333 <exit>
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
  dc:	66 90                	xchg   %ax,%ax
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 10 08 00 00 	jmp    *0x810(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 08 08 00 00       	mov    $0x808,%edx
        while(*s != 0){
