...
int main(int argc, char*argv[])
{
  ...
  30:	52                   	push   %edx
  31:	50                   	push   %eax
  32:	e8 09 00 00 00       	call   40 <save>
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
  3d:	66 90                	xchg   %ax,%ax
...
void save(int argc, char*argv[]){
  ...
  49:	8b 75 0c             	mov    0xc(%ebp),%esi
	file = open(argv[1], O_WRONLY); // if the file exists then open and write
  4c:	6a 01                	push   $0x1
  4e:	ff 76 04             	push   0x4(%esi)
  51:	e8 2d 03 00 00       	call   383 <open>
	if(file < 0){
  56:	83 c4 10             	add    $0x10,%esp
  59:	89 c3                	mov    %eax,%ebx
  5b:	85 c0                	test   %eax,%eax
  5d:	78 62                	js     c1 <save+0x81>
		if(i != argc - 1)
  5f:	8b 45 08             	mov    0x8(%ebp),%eax
	for(int i = 2; i <argc; i++)
  62:	bf 02 00 00 00       	mov    $0x2,%edi
		if(i != argc - 1)
  67:	83 e8 01             	sub    $0x1,%eax
	for(int i = 2; i <argc; i++)
  6a:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
		if(i != argc - 1)
  6e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	for(int i = 2; i <argc; i++)
  71:	7e 40                	jle    b3 <save+0x73>
  73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  77:	90                   	nop
		write(file, argv[i],strlen(argv[i]));
  78:	83 ec 0c             	sub    $0xc,%esp
  7b:	ff 34 be             	push   (%esi,%edi,4)
  7e:	e8 fd 00 00 00       	call   180 <strlen>
  83:	83 c4 0c             	add    $0xc,%esp
  86:	50                   	push   %eax
  87:	ff 34 be             	push   (%esi,%edi,4)
  8a:	53                   	push   %ebx
  8b:	e8 d3 02 00 00       	call   363 <write>
		if(i != argc - 1)
  90:	83 c4 10             	add    $0x10,%esp
  93:	3b 7d e4             	cmp    -0x1c(%ebp),%edi
  96:	74 13                	je     ab <save+0x6b>
		 write(file, " ",1);
  98:	83 ec 04             	sub    $0x4,%esp
  9b:	6a 01                	push   $0x1
  9d:	68 f8 07 00 00       	push   $0x7f8
  a2:	53                   	push   %ebx
  a3:	e8 bb 02 00 00       	call   363 <write>
  a8:	83 c4 10             	add    $0x10,%esp
	for(int i = 2; i <argc; i++)
  ab:	83 c7 01             	add    $0x1,%edi
  ae:	39 7d 08             	cmp    %edi,0x8(%ebp)
  b1:	75 c5                	jne    78 <save+0x38>
	close(file);
  b3:	83 ec 0c             	sub    $0xc,%esp
  b6:	53                   	push   %ebx
  b7:	e8 af 02 00 00       	call   36b <close>
	exit();
  ...
  c1:	52                   	push   %edx
  c2:	52                   	push   %edx
  c3:	68 01 02 00 00       	push   $0x201
  c8:	ff 76 04             	push   0x4(%esi)
  cb:	e8 b3 02 00 00       	call   383 <open>
	if(file < 0){
  ...
  d7:	79 86                	jns    5f <save+0x1f>
	printf(2, "cannot open the file %s from the save command \n", argv[1]);
  d9:	50                   	push   %eax
  da:	ff 76 04             	push   0x4(%esi)
  dd:	68 c8 07 00 00       	push   $0x7c8
  e2:	6a 02                	push   $0x2
  e4:	e8 b7 03 00 00       	call   4a0 <printf>
	exit();
  e9:	e8 55 02 00 00       	call   343 <exit>
  ee:	66 90                	xchg   %ax,%ax
 ...
 641:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 40 0b 00 00    	mov    %edx,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 40 0b 00 00    	mov    0xb40,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 40 0b 00 00 44 	movl   $0xb44,0xb40
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 44 0b 00 00       	mov    $0xb44,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 7b2:	00 00 00 
    if(p->s.size >= nunits){
