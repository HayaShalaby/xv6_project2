...
user/_getppid_test:     file format elf64-littleriscv
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 62e:	286b8b93          	addi	s7,s7,646 # 8b0 <digits>
 ...
 690:	21c90913          	addi	s2,s2,540 # 8a8 <malloc+0x110>
        for(; *s; s++)
